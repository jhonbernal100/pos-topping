...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .tabla-discriminada { margin: 0 16px 16px; }
    table { width:100%; border-collapse:collapse; }
    th { background:#000; color:#fff; padding:7px; font-size:10px; text-align:left; }
    ...
    .seccion-titulo { font-size:12px; font-weight:bold; margin: 16px 16px 8px; border-bottom:2px solid #000; padding-bottom:4px; }
</style>
</head>
<body>
...
{{-- Tabla discriminada por metodo de pago --}}
<div class="tabla-discriminada">
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr style="background:#000;color:#fff;">
                ...
                <td style="padding:7px 8px;text-align:center;color:#fff;font-weight:bold;">{{ $totalVentas }}</td>
